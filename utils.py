...
_UP_STATUS_PHRASE_UA = (
    ...
    ("unsuccessful delivery (transfer to storage)", "На зберіганні"),
    ("attempted/unsuccessful delivery", "Невдала доставка"),
    ("returning to the sender's address", "Повернення"),
    ("returning of shipment", "Повернення"),
    ("shipment is forwarded to other postoffice", "Переадресовано"),
    ("departure to delivery office", "До відділення"),
    ("arrival to delivery office", "У відділенні"),
    ("arrival to the branch office", "У відділенні"),
    ("income to sorting center", "Сорт. центр"),
    ("shipment accepted at the branch", "Прийнято"),
